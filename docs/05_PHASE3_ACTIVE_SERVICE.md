...
>
> **近期同步**:
> - **Selection Context / 上下文附件 (v0.7.0)**: 前端 SelectionItem + dashboardStore + NewsFeed "问这条"按钮 + Selection Pill UI + 后端 SelectionContext 模型，详见 [feature_logs/2026-02-01_selection_context.md](./feature_logs/2026-02-01_selection_context.md)
...
> 本文档为历史阶段规划；后续架构与开发以 LangGraph 重构指南为准。
---
