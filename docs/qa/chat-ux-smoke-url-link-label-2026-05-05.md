...
- Started at: `2026-05-05T23:23:51`
...
|---|---|---|---|---|---:|---|
| Q39 | multiple_simple_complex_url | PASS | chat | research | 46481 | - |
...
**Eval Session:** `eval-nested-url-link-label-2026-05-05`
...
---
AAPL 最新价格约为 279.74 USD，变动 2.87 / 1.04%。
MSFT 最新价格约为 410.24 USD，变动 -3.38 / -0.82%。

https://example.com/msft-rates 相关链接这次没有拿到可读正文（fetch_failed）：https://example.com/msft-rates。所以我先不把它当作支持证据，只能说需要换成可访问正文后再判断。
