...
- Started at: `2026-05-05T22:59:12`
...
|---|---|---|---|---|---:|---|
| Q39 | multiple_simple_complex_url | PASS | chat | research | 123062 | - |
...
**Eval Session:** `eval-nested-smoke-url-no-context-router`
...
---
AAPL 最新价格约为 280.40 USD，变动 3.53 / 1.27%。
MSFT 最新价格约为 410.51 USD，变动 -3.11 / -0.75%。
