  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 gap-3">
      ...
      <button
        ...
        onClick={onGenerate}
        disabled={loading}
        className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-lg bg-fin-primary/15 text-fin-primary hover:bg-fin-primary/25 hover:border-t-accent/40 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
      >
        {loading ? (
